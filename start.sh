...
setup_vllm() {
    ...
    vllm serve Qwen/Qwen3-VL-8B-Thinking --max-num-seqs 2 --tensor-parallel-size 1 --gpu-memory-utilization 0.7 --allowed-local-media-path / --enforce-eager --port $VLLM_PORT
}
